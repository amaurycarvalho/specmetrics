...
Normalized documents are transformed into semantic elements (facts, entities, relationships, operations) via pluggable extraction providers. An LLM-assisted provider is included by default, with a structural fallback when no API key is configured. Each extracted element maintains an `EvidenceReference` linking back to the source document and section.
...
### 7. Canonical Specification Model (CSM) with 9 Categories
...
### 8. Measurement Engines as Deterministic Plugins
...
### 9. Rule Pack Engine for Externalized Policies
...
### 10. Two Interaction Interfaces (CLI and MCP)
...
### 11. Hierarchical Configuration System
...
### 12. Export Layer and OpenTelemetry Publisher
...
### 13. Validation as an Independent Stage
...
### 14. Calibration Profile System (Token Points, Cognitive Points)
...
### 15. Explainability as a First-Class Concern
...
### 16. Graceful Degradation Pattern
