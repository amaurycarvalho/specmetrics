...
Define the classifiers that translate quantitative indicator values into qualitative business language — separating dominance (CLV-based) from conviction (Daily Efficiency-based) to preserve interpretability.
