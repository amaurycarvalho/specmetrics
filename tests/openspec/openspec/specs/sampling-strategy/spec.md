...
Define the sampling strategy capabilities for FlowScope, including period selection (30/60/90 days) and sampling method selection (Fibonacci, Fibonacci reverse, Fibonacci double, Monte Carlo, Monte Carlo double, all days) for historical date selection.
