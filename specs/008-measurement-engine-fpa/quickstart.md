# Quickstart: FPA Measurement Plugin
...
The FPA measurement plugin is discovered automatically via Python Entry Points when installed:
...
# Expected output includes: "fpa — IFPUG/FPA Function Point Analysis (measurement)"
```

## Validation Scenarios

### Scenario 1: Basic FPA Measurement
...
# See: specs/008-measurement-engine-fpa/tests/unit/test_counter.py
```
...
from specmetrics.plugins.measurement.fpa import FPAMeasurementPlugin
...
**Data Model Reference**: [data-model.md](../data-model.md) — `FPAMeasurementResult`, `MeasuredFunction`
...
**Purpose**: Verify the FPA plugin is discoverable via Python Entry Points.
...
**Expected Outcome**:
- Output includes: `Discovered: fpa -> specmetrics.plugins.measurement.fpa:FPAMeasurementPlugin`
...
pytest tests/unit/measurement/fpa/ -v
pytest tests/integration/measurement/fpa/ -v
```
